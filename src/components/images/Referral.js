...
export default function Referral(props) {
  ...
  return (
    <Svg width={width} height={height} viewBox="0 0 555 333">
      <Defs>
        <LinearGradient
          id="linear-Gradient"
          x1="0.5"
      ...
      <G id="Refer" clipPath="url(#clip-Refer)">
        <Path
          id="Path_62302"
          fill="#020d88"
        ...
        <G
          ...
          transform="translate(-27 -6060.481)">
          <G id="kim5" transform="translate(39.469 6133.613)">
            <Path
              id="hairback"
              fill="#0a0f4d"
            ...
            <G id="neck" transform="translate(102.953 66.884)">
              <Path
                id="Intersection_2"
                fill="#020d88"
            ...
            <G id="face" transform="rotate(-7 249.504 -683.923)">
              <Path
                id="Union_15"
                fill="#d5d6e2"
                stroke="#020d88"
            ...
            <G id="hair-front" transform="rotate(-7 119.305 -682.82)">
              <Path
                id="Union_14"
                fill="#0a0f4d"
            ...
            <G id="arm2" fill={primary} transform="rotate(87 52.958 170.227)">
              <Path
                id="primary-2"
            ...
            <G id="arm1" transform="rotate(177 68.07 130.921)">
              <Path
                id="primary-4"
                fill={primary}
        ...
        <G
          ...
          transform="translate(191 39.718)">
          <G id="jon3" transform="translate(9.788)">
            <Path
              id="Union_19"
              fill="#9c9ecc"
              stroke="#020d88"
            ...
            <G id="arm-back" transform="rotate(14 -297.616 173.686)">
              <G id="phone" transform="rotate(179.026 18.662 38.248)">
                <G
                  id="RectanGle_1134"
                  fill="#e4e6fc"
            ...
            <G id="arm-front" transform="translate(154.53 123.211)">
              <Path
                id="Union_20"
                fill="#9c9ecc"
                stroke="#020d88"
            ...
            <G
              id="face-2"
              data-name="face"
              transform="rotate(4.992 18.69 2065.41)">
              <Path
                id="Path_6"
                fill="#ac6f4c"
        ...
        <G id="laptop" transform="translate(126.135 218.383)">
