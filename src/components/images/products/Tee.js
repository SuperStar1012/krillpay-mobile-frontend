...
export default function Data(props) {
  ...
  return (
    <Svg
      ...
      <G id="Tee" clipPath="url(#clip-Tee)">
        <Path
          id="primary"
          fill={primary}
          d="M0 0h110v70S81.016 83.887 53.516 83.887 0 70 0 70z"
          opacity="0.35"
          transform="translate(45 114)"></Path>
        <Path
          id="primary-2"
          fill={primary}
        ...
        <Path
          id="primary-3"
          fill={primary}
          d="M0 0h25v15.5A12.5 12.5 0 0112.5 28 12.5 12.5 0 010 15.5V0z"
          data-name="primary"
          opacity="0.35"
          transform="translate(119 54)"></Path>
      </G>
    </Svg>
  );
}
