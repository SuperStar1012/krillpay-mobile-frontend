...
export default function CampaignCard(props) {
  ...
  const { currency, fixed_amount, name, type, percentage, image } = item;
    ...
    <TouchableOpacity
      ...
      <View
        ...
        <View style={{ zIndex: 10, minHeight: 60 }}>
          {isPercentage ? (
            <React.Fragment>
              <Text s={16} style={{ marginTop: 6, marginBottom: 2 }}>
                {name}
              </Text>
              <View fD="row" aI="flex-end" pb={0.5}>
                <Text c="primary" fW="700" s={17}>
                  {'Earn ' + percentageString}
                </Text>
              </View>
            </React.Fragment>
